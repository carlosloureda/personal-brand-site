...
const SingleReview = ({ title, content, url }) => {
  ...
  return (
    <Col lg="4" md="6">
      <SingleReviewDiv className="single-Review">
      ...
      <Container>
        <Row className="d-flex justify-content-center">
          <div className="menu-content pb-70 col-lg-8">
            <div className="title text-center">
              <h1 className="mb-10">Some of my latest Reviews</h1>
        ...
        <Row>
          ...
          <SingleReview
            ...
            url={url}
          />
          <SingleReview title="Patricia Saco" content={sacoComment} url={url} />
          {/* <SingleReview title="Highly Recomended" content={mockedContent} />
          <SingleReview title="Positive Reviews" content={mockedContent} /> */}
        </Row>
      </Container>
    </ReviewsSection>
  );
